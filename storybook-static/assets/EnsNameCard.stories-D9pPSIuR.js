import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{C as v}from"./ChainIcon-DSKpsAIN.js";import{T as o}from"./Text-DmuCryDF.js";import{I as f}from"./Icon-D7kVSi4N.js";import"./index-yBjzXJbu.js";import"./index-BUSIDwT2.js";const h=({children:a,className:s="",...n})=>e.jsx("div",{className:`ns-card ${s}`,...n,children:a});h.__docgenInfo={description:"",methods:[],displayName:"Card",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},className:{defaultValue:{value:'""',computed:!1},required:!1}}};const i=({name:a,imageUrl:s,expires:n,chain:N="eth",className:x=""})=>e.jsxs(h,{className:`ens-name-card ${x}`,children:[e.jsxs("div",{className:"ens-card-image-container",children:[e.jsx("img",{src:s,alt:`${a} avatar`,className:"ens-card-image"}),e.jsx("div",{className:"ens-card-badge",children:e.jsx(v,{chain:N,size:25})})]}),e.jsxs("div",{className:"ens-card-body",children:[e.jsx(o,{weight:"bold",children:a}),e.jsxs("div",{className:"ens-card-expiry",children:[e.jsx(f,{name:"clock",size:14}),e.jsxs(o,{size:"sm",children:["Expires ",n]})]})]})]});i.__docgenInfo={description:"",methods:[],displayName:"ENSNameCard",props:{name:{required:!0,tsType:{name:"string"},description:""},imageUrl:{required:!0,tsType:{name:"string"},description:""},expires:{required:!0,tsType:{name:"string"},description:""},chain:{required:!1,tsType:{name:"union",raw:`| "eth"
| "arb"
| "base"
| "bitcoin"
| "matic"
