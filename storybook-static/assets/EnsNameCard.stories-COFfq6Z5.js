import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{C as W}from"./ChainIcon-DSKpsAIN.js";import{T as h}from"./Text-DmuCryDF.js";import{I as L}from"./Icon-D2aLcssT.js";import"./index-yBjzXJbu.js";import"./index-BUSIDwT2.js";const _=({children:a,className:r="",...d})=>e.jsx("div",{className:`ns-card ${r}`,...d,children:a});_.__docgenInfo={description:"",methods:[],displayName:"Card",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},className:{defaultValue:{value:'""',computed:!1},required:!1}}};const l=({name:a,imageUrl:r,expires:d,chain:O="eth",className:P=""})=>e.jsxs(_,{className:`ens-name-card ${P}`,children:[e.jsxs("div",{className:"ens-card-image-container",children:[e.jsx("img",{src:r,alt:`${a} avatar`,className:"ens-card-image"}),e.jsx("div",{className:"ens-card-badge",children:e.jsx(W,{chain:O,size:25})})]}),e.jsxs("div",{className:"ens-card-body",children:[e.jsx(h,{weight:"bold",children:a}),e.jsxs("div",{className:"ens-card-expiry",children:[e.jsx(L,{name:"clock",size:14}),e.jsxs(h,{size:"sm",children:["Expires ",d]})]})]})]});l.__docgenInfo={description:"",methods:[],displayName:"ENSNameCard",props:{name:{required:!0,tsType:{name:"string"},description:""},imageUrl:{required:!0,tsType:{name:"string"},description:""},expires:{required:!0,tsType:{name:"string"},description:""},chain:{required:!1,tsType:{name:"union",raw:`| "eth"
| "arb"
| "base"
| "bitcoin"
| "matic"
